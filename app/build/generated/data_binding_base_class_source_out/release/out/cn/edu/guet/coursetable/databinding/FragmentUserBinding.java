...
public final class FragmentUserBinding implements ViewBinding {
  ...
  private FragmentUserBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnToLogin) {
  ...
  public static FragmentUserBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentUserBinding((ConstraintLayout) rootView, btnToLogin);
    }
