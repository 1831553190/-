...
public final class SpinnerItemBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView spinnerWeek;

  private SpinnerItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView spinnerWeek) {
  ...
  public static SpinnerItemBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.spinner_week;
      TextView spinnerWeek = rootView.findViewById(id);
      if (spinnerWeek == null) {
        break missingId;
      }

      return new SpinnerItemBinding((ConstraintLayout) rootView, spinnerWeek);
    }
